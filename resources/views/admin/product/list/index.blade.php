                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a class="btn btn-sm bg-gradient-primary"
                                href="{{ route('product.list.create') }}"><i class="fas fa-plus mr-2"></i>Create
                                New</a>
                        </li>
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="project-actions text-left">
                                <form method="POST" action="{{ route('product.list.destroy', ['id' => $value['id']]) }}"
                                    class="delete-form">
                ...
                {{ $productLists->onEachSide(1)->appends(request()->all())->links() }}
            </div>
            <!-- /.card-body -->
        </div>
        <!-- /.card -->
