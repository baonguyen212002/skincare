...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('/soft') }}" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="{{ url('/') }}" class="nav-link"><i style="color: #f08700;" class="fas fa-reply"></i> Trở về website của bạn</a>
                </li>
                <!-- Navbar Search -->
                <li class="nav-item">
    ...
    @include('admin.layout.modal_notifycation')
